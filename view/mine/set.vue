<template>
	<view class="template-set main-container tn-safe-area-inset-bottom">
		<!-- 顶部自定义导航 -->
		<uni-nav-bar statusBar class="custom-nav" :fixed="true" :border="false" title="设置" left-icon="left"
	...
	export default {
		...
		methods: {
			...
			logout() {
				...
				this.$tn.vuex('vuexUserInfo', {})
				this.$tn.vuex('vuexMerchantStoreInfo', {})
				this.$tn.vuex('vuexMerchantInfo', {})
				clearTokenInfo()
				clearUserInfo()
				clearMerchantStoreInfo()
				clearMerchantInfo()
